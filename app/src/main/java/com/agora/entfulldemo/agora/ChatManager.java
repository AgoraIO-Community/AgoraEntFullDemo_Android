package com.agora.entfulldemo.agora;
...
public class ChatManager {
    ...
    public void init() {
        try {
            mRtmClient = RtmClient.createInstance(mContext, BuildConfig.APP_ID, new RtmClientListener() {
                @Override
            ...
            if (BuildConfig.DEBUG) {
                mRtmClient.setParameters("{\"rtm.log_filter\": 10}");
            }
        } catch (Exception e) {
