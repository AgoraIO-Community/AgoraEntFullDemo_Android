...
//        AgoraApplication.the().getChatManager().unregisterListener(this);
    ...
    public void doLoginRTM() {
        AgoraApplication.the().getRtmClient().login(null,
                UserManager.getInstance().getUser().userNo, new ResultCallback<Void>() {
                    @Override
    ...
    public void onMessageReceived(RtmMessage rtmMessage, RtmChannelMember rtmChannelMember) {
        Log.d(TAG, "onMessageReceived rtmMessage getRawMessage = " + new String(rtmMessage.getRawMessage()));
