...
public final class CommonTitleView extends ConstraintLayout {
    ...
    private final void initView(AttributeSet attrs, int defStyleAttr) {
        ...
        this.binding.ivBackIcon.setOnClickListener((OnClickListener) (new OnClickListener() {
    ...
    public final void setLeftClick(@Nullable OnClickListener onClickListener) {
    ...
    public final void setRightIconClick(@Nullable OnClickListener onClickListener) {
        if (onClickListener != null) {
